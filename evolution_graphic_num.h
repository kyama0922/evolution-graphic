...
namespace EVOLUTION{
    namespace GRAPHIC{
        ...
        */
        ...
        /*コンスタントバッファレイアウト
        例1
        EVOLUTION::GRAPHIC::CONSTANT_BUFFER_LAYOUT constant_buffer_layout[] = {
        { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_MATRIX, 0 },//ViewProjectionMatrix
        { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_MATRIX, 0 },//WorldMatrix
        };

        例2
        EVOLUTION::GRAPHIC::CONSTANT_BUFFER_LAYOUT materialt[] = {
         { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_FLOAT4_ARRAY, 4 },//DiffuseColor
         { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_FLOAT4_ARRAY, 4 },//AmbientColor
         { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_FLOAT4_ARRAY, 4 },//SpecularColor
         { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_FLOAT4_ARRAY, 4 },//EmissiveColor
         { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_FLOAT, 0 },//PowerColor
        };

        例3
        EVOLUTION::GRAPHIC::CONSTANT_BUFFER_LAYOUT constant_buffer_layout[] = {
        { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_FLOAT, 0 },
        { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_INT, 0 },
        { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_FLOAT3, 0 },
        { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_FLOAT3_ARRAY, 4 },
        { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_MATRIX, 0 },
        { EVOLUTION::GRAPHIC::CONSTANT_BUFFER_INSTANCE_TYPE::_MATRIX, 0 },
        };
        */
